...
@section('main')
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- form -->
            <div class="col-12">
                <form action="{{route('genres.update',$gen->id)}}" class="sign__form sign__form--add">
                    <div class="row">
                                ...
                                <div class="sign__season">
                                    <div class="sign__season-head">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-4 col-md-3 col-xl-2">
                                                <button class="sign__btn sign__btn--add"><span>add
                                                        season</span></button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sign__episode">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="sign__video">
                                                    <label id="s1s1" for="sign__video-upload1">Upload episode
                                                        1</label>
                                                    <input data-name="#s1s1" id="sign__video-upload1" name="s1s1"
                                    ...
                                    <div class="sign__episode">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-8 col-md-9 col-xl-10">
                                                <div class="sign__video">
                                                    <label id="s1s2" for="sign__video-upload2">Upload episode
                                                        2</label>
                                                    <input data-name="#s1s2" id="sign__video-upload2" name="s1s2"
                                                        class="sign__video-upload" type="file"
                                                        accept="video/mp4,video/x-m4v,video/*">
                                                </div>
                                            </div>
