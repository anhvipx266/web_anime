            ...
            <div class="row">
                <div class="col-12">
                    <div class="sign__content">
                        <!-- registration form -->
                        <form action="{{route('admin.accounts.register')}}" method="POST" class="sign__form" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            ...
                            <div class="sign__group">
                                <input type="text" class="sign__input" placeholder="Địa chỉ" name="address">
                            </div>
                            ...
                            <span class="sign__text">Already have an account? <a href="{{route('admin.accounts.signin')}}">Sign in!</a></span>
                        </form>
                        <!-- registration form -->
                    </div>
                </div>
