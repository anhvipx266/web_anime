...
<div class="sidebar">
    <!-- sidebar logo -->
    <a href="{{route('admin.home')}}" class="sidebar__logo">
    ...
    <div class="sidebar__user">
        <div class="sidebar__user-img">
            <img src="{{auth()->guard('staff')->user()->avatar}}" alt="avatar">
        </div>

        <div class="sidebar__user-title">
            <span>{{auth()->guard('staff')->user()->role->role}}</span>
            <p>{{auth()->guard('staff')->user()->name}}</p>
        </div>

        <a href="{{route('admin.accounts.logout')}}" class="sidebar__user-btn" type="button">
    ...
    <ul class="sidebar__nav">
        <li class="sidebar__nav-item">
            <a href="{{route('admin.home')}}" class="sidebar__nav-link sidebar__nav-link--active"><svg
        ...
        <li class="sidebar__nav-item">
            <a href="{{route('admin.genres.index')}}" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24">
                    <path
        ...
        <li class="sidebar__nav-item">
            <a href="{{route('admin.movies.index')}}" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24">
                    <path
                        d="M21,2a1,1,0,0,0-1,1V5H18V3a1,1,0,0,0-2,0V4H8V3A1,1,0,0,0,6,3V5H4V3A1,1,0,0,0,2,3V21a1,1,0,0,0,2,0V19H6v2a1,1,0,0,0,2,0V20h8v1a1,1,0,0,0,2,0V19h2v2a1,1,0,0,0,2,0V3A1,1,0,0,0,21,2ZM6,17H4V15H6Zm0-4H4V11H6ZM6,9H4V7H6Zm10,9H8V13h8Zm0-7H8V6h8Zm4,6H18V15h2Zm0-4H18V11h2Zm0-4H18V7h2Z" />
                </svg>Phim</a>
        ...
        <li class="sidebar__nav-item">
            <a href="/users" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
        ...
        <li class="sidebar__nav-item">
            <a href="/comments" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24">
                    <path
        ...
        <li class="sidebar__nav-item">
            <a href="/reviews" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <li class="sidebar__nav-item">
            <a class="sidebar__nav-link" href="#" role="button" data-bs-toggle="dropdown"
                aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
    ...
    <div class="sidebar__copyright">© FlixGo, 2018—2023. <br>Create by <a
            href="https://themeforest.net/user/dmitryvolkov/portfolio" target="_blank" rel="noopener">Dmitry Volkov</a>.
    </div>
