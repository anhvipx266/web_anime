...
@section('title','Tạo Vai trò Nhân viên')
...
@section('main')
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- form -->
            <div class="col-12">
                <form action="{{empty($v)?route('admin.staff_roles.store'):route('admin.staff_roles.update',$v)}}" method="POST" class="sign__form sign__form--add" enctype="multipart/form-data">
                    @csrf
                    @if(!empty($v))
                        @method('patch')
                    @endif
