...
@section('main')
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- form -->
            <div class="col-12">
                <form action="{{empty($gen)?route('admin.users.store'):route('admin.users.update',$gen)}}" method="POST" enctype="multipart/form-data" class="sign__form sign__form--add">
                    @csrf
                    @if(!empty($gen))
                        @method('patch')
                    @endif
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="sign__group">
                                        ...
                                        <ul class="sign__radio">
                                            <li>
                                                <input id="type1" type="radio" {{!empty($v) && $v->gender==1?'checked':''}} name="gender" data-bs-toggle="collapse"
                                                    data-bs-target=".multi-collapse" checked value="1">
                                                <label for="type1">Nam</label>
                                            </li>
                                            <li>
                                                <input id="type2" type="radio" {{!empty($v) && $v->gender==0?'checked':''}} name="gender" value ="0" data-bs-toggle="collapse"
                                    ...
                                    <div class="sign__group">
                                        ...
                                        <ul class="sign__radio">
                                            ...
                                            <li>
                                                <input id="type2" type="radio" {{!empty($v) && $v->status==0?'checked':''}} name="status" value ="0" data-bs-toggle="collapse"
                                                    data-bs-target=".multi-collapse">
                                    ...
                                    <div class="sign__group">
                                        ...
                                        <select class="sign__selectjs" id="sign__country" name="user_role">
                                            @foreach ($user_roles as $role)
                                                <option value="{{$role->id}}" {{!empty($v) && $v->user_role==$role->id?'selected':''}}>{{$role->role}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
